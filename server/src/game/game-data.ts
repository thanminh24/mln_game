// Migrated from assets/game1-questions.csv and assets/game2-questions.csv
...
export interface G1Row {
  ...
  word_length: number;
  col_offset: number;
  keyword_col: string; // letter at column 12
...
export const G1_DATA: G1Row[] = [
  ...
  },
  {
    ...
    answer_display: "ĐIỀU KIỆN TỰ NHIÊN",
  },
  {
    row_index: 2,
    ...
    answer_display: "PHƯƠNG THỨC SẢN XUẤT VẬT CHẤT",
  },
  {
    row_index: 3,
  ...
  },
  {
    ...
    answer_display: "Ý THỨC XÃ HỘI THÔNG THƯỜNG",
  },
  {
    row_index: 5,
    ...
    answer_display: "Ý THỨC XÃ HỘI VƯỢT TRƯỚC TỒN TẠI XÃ HỘI",
  },
  {
    row_index: 6,
    ...
    answer_display: "Ý THỨC ĐẠO ĐỨC",
  },
];

const ROUND1_EXPLANATION =
...
export const G2_DATA: G2Round[] = [
  {
    ...
    round_explanation: ROUND1_EXPLANATION,
    cau_hoi: [
      {
        question_index: 0,
        question_text:
      ...
      },
      {
        question_index: 1,
        question_text:
          "Xét dưới góc độ Triết học Mác - Lênin, tinh thần yêu nước, ý chí quyết chiến quyết thắng và lòng tự hào dân tộc của quân và dân ta trong cuộc chiến này thuộc về phạm trù nào sau đây?",
      ...
      },
      {
        question_index: 2,
        question_text:
          "Để bảo đảm hậu cần cho chiến trường trọng điểm này, hàng vạn dân công hỏa tuyến đã đồng lòng sử dụng phương tiện thô sơ nào dưới đây để vận chuyển hơn 2 vạn tấn lương thực?",
        opt_A: "Xe ba gác",
      ...
      },
      {
        question_index: 3,
        question_text:
          "Sức mạnh của lòng yêu nước giúp nền nông nghiệp lạc hậu đánh bại thế lực có tiềm lực quân sự, kinh tế hiện đại. Hiện tượng này chứng minh cho luận điểm triết học nào?",
        opt_A: "Ý thức xã hội luôn luôn lạc hậu hơn tồn tại xã hội.",
        opt_B: "Tồn tại xã hội hoàn toàn độc lập với ý thức xã hội.",
        opt_C:
          "Tính độc lập tương đối và sự tác động trở lại mạnh mẽ của YTXH đối với TTXH.",
      ...
      },
      {
        question_index: 4,
        question_text:
          "Lá cờ 'Quyết chiến - Quyết thắng' tung bay trên nóc hầm chỉ huy của viên tướng Pháp nào, đánh dấu sự sụp đổ hoàn toàn của tập đoàn cứ điểm này?",
  ...
  },
  {
    ...
    round_explanation: ROUND2_EXPLANATION,
    cau_hoi: [
      {
        question_index: 0,
        question_text:
          "Nước ta có vị trí địa lý đặc thù, thường xuyên đối mặt với điều kiện thời tiết khắc nghiệt. Theo triết học Mác - Lênin, yếu tố này thuộc về phạm trù nào?",
      ...
      },
      {
        question_index: 1,
        question_text:
          "Từ hoàn cảnh sống nhiều gian khó đó, người Việt đã sớm hình thành truyền thống đùm bọc lẫn nhau. Theo chủ nghĩa duy vật lịch sử, sự hình thành này minh chứng cho quy luật nào?",
      ...
      },
      {
        question_index: 2,
        question_text:
          "Trải qua ngàn năm, truyền thống 'thương người như thể thương thân' vẫn luôn được các thế hệ người Việt gìn giữ. Điều này thể hiện đặc tính nào của Ý thức xã hội?",
      ...
      },
      {
        question_index: 3,
        question_text:
          "Khi cộng đồng gặp biến cố, tình cảm trừu tượng lập tức biến thành những hành động thiết thực đóng góp sức người, sức của để tái thiết cuộc sống. Đây là biểu hiện của nguyên lý nào?",
      ...
      },
      {
        question_index: 4,
        question_text:
          "Từ mối quan hệ biện chứng trên, có thể kết luận tinh thần đoàn kết của người Việt Nam không chỉ là lý thuyết suông mà đã biến thành:",
